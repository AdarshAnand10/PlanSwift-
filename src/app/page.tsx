    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 md:py-32 bg-background">
          <div className="container mx-auto px-4 text-center">
             <Image src="https://placehold.co/800x400.png" alt="Business planning process" width={800} height={400} className="mx-auto mb-8 rounded-lg shadow-2xl" data-ai-hint="team collaboration" />
